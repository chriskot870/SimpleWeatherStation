/*
 * Copyright 2025 Chris Kottaridis
 */
...
namespace qw_devices {
  ...
  map<Ads1015DeviceLocation, shared_ptr<Ads1015DeviceData>> I2cAds1015::ads1015_devices;

  I2cAds1015::I2cAds1015(I2cBus i2cbus, uint8_t slave_address) : i2cbus_(i2cbus), slave_address_(slave_address) {
