...
target_command="/usr/local/qw/tests/units.test"
target_stdin="/dev/null"
target_stdout="/var/tmp/weather_station.out"
target_stderr="/dev/null"
target_user="chrisk"
build_command="build/src/lib/qw/units/tests/units.test"
